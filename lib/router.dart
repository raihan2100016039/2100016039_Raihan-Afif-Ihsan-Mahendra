...
class ReplyRouterDelegate extends RouterDelegate<ReplyRoutePath>
      ...
      child: Selector<RouterProvider, ReplyRoutePath?>(
        ...
        builder: (context, routePath, child) {
          return Navigator(
            ...
            pages: [
              // Menggunakan SharedAxisTransitionPageWrapper untuk halaman dengan transisi Shared Axis
  ...
  bool _handlePopPage(Route<dynamic> route, dynamic result) {
    // _handlePopPage tidak boleh dipanggil di halaman utama karena
    // PopNavigatorRouterDelegateMixin akan naik ke SystemNavigator
    // jika hanya ada satu rute dalam navigator.
...
// Menambahkan transisi Shared Z-Axis dari ikon pencarian ke halaman tampilan pencarian
